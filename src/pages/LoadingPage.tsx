  ...
  return (
    <AppLayout title="">
      <div className="flex flex-col items-center justify-center p-4 w-full mx-auto min-h-[60vh]">
        {/* Redesigned header with softer gradient and smaller text */}
        <div className="relative w-full h-32 bg-gradient-to-r from-sky-500 via-indigo-400 to-blue-500 overflow-hidden rounded-t-xl">
          ...
          <div className="absolute inset-0">
            ...
            <div className="absolute top-1/3 right-1/3 w-32 h-32 bg-blue-300/20 rounded-full blur-2xl animate-float" style={{ animationDelay: '0.7s' }}></div>
            
            {/* Subtle particle effects */}
            <div className="absolute top-10 left-20 w-2 h-2 bg-blue-200 rounded-full animate-float"></div>
            <div className="absolute top-20 right-40 w-3 h-3 bg-sky-200 rounded-full animate-float" style={{ animationDelay: '1.2s' }}></div>
            <div className="absolute bottom-10 left-1/3 w-4 h-4 bg-indigo-200 rounded-full animate-float" style={{ animationDelay: '0.5s' }}></div>
          </div>
          
          {/* Minimalist version of morphing text */}
          <div className="absolute inset-0 flex items-center justify-center z-10">
            <h2 className="text-2xl font-medium text-white tracking-wide drop-shadow-sm">
              Processing Content
            </h2>
          </div>
        ...
        <div className="p-8 backdrop-blur-sm bg-white/5 dark:bg-black/10 w-full rounded-b-xl border border-blue-100/20 dark:border-blue-900/20">
          <div className="mb-8 relative">
            {/* Enhanced progress bar with new blue gradient */}
            <div className="h-4 bg-gray-200/30 dark:bg-gray-700/30 rounded-full overflow-hidden backdrop-blur-sm shadow-inner">
              <div 
                className="h-full bg-gradient-to-r from-sky-500 via-blue-500 to-indigo-600 transition-all duration-500 ease-out relative"
              ...
              <div 
                ...
                style={{ 
                  width: `${progress}%`, 
                  background: 'linear-gradient(90deg, rgba(56,189,248,0.5) 0%, rgba(59,130,246,0.5) 100%)' 
                }}
              ></div>
            </div>
            <div className="mt-2 text-right text-sm font-medium text-blue-600 dark:text-blue-400">
              {progress}% Complete
            </div>
            
            {/* Progress dots with updated styling */}
          ...
          {/* Three phase cards with updated color scheme */}
                ...
                <Card
                  ...
                  className={cn(
                    ...
                    isComplete
                      ...
                      : isActive 
                        ? "bg-gradient-to-br from-blue-50 to-sky-50 dark:from-blue-900/20 dark:to-sky-900/30 shadow-lg shadow-blue-100/50 dark:shadow-blue-900/20"
                        : "bg-white/80 dark:bg-gray-800/40 shadow-sm"
                  )}
                >
                  {/* Background pattern with updated styling */}
                  <div className={cn(
                      ...
                      <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
                        <defs>
                          <pattern id={`grid-${phase.id}`} width="20" height="20" patternUnits="userSpaceOnUse">
                            <circle cx="10" cy="10" r="1" fill={isComplete ? "#10B981" : isActive ? "#0ea5e9" : "#9CA3AF"} />
                          </pattern>
                        </defs>
                  ...
                  {/* Card content with updated styling */}
                  <div className="p-6 relative z-10">
                    ...
                    {/* Animated progress bar for active phase with updated colors */}
                    {isActive && (
                      <div className="mt-3 h-1 w-full bg-gray-200 dark:bg-gray-700 overflow-hidden rounded-full">
                        <div className="h-full bg-gradient-to-r from-blue-400 via-sky-500 to-blue-600 dark:from-blue-500 dark:via-sky-400 dark:to-blue-300 animate-progress-indeterminate"></div>
                      </div>
                    )}
                  </div>
                </Card>
          ...
          <div className="flex justify-center mt-10 relative overflow-hidden py-6">
            {/* Animated particle background with updated styling */}
            <div className="absolute inset-0 overflow-hidden">
              {[...Array(20)].map((_, i) => (
                <div 
                  key={i}
                  className="absolute rounded-full bg-gradient-to-r from-sky-300 to-blue-300 dark:from-sky-500 dark:to-blue-400 opacity-30 animate-float" 
                  style={{
            ...
            {/* Main text with updated styling */}
            <div className="text-center z-10">
              <div className="text-gray-600 dark:text-gray-300 text-sm font-medium">
                <span>Transforming content into platform-optimized assets</span>
              </div>
              
              {/* Animated dots with updated styling */}
              <div className="flex justify-center mt-1.5">
                {[0, 1, 2].map((dot) => (
                  <div 
                    key={dot}
                    className="w-2 h-2 rounded-full bg-gradient-to-r from-sky-500 to-blue-500 dark:from-sky-400 dark:to-blue-300 mx-0.5 animate-bounce"
