    ...
    const prepareVideos = async () => {
      ...
      if (videoList.length > 0) {
        try {
          ...
          if (!videoResponse.ok) {
            toast.info("Your video is still being generated. This may take up to 40 minutes.");
          }
        } catch (error) {
      ...
      <div className="w-full bg-gradient-to-br from-purple-100 via-purple-50 to-white dark:from-purple-900 dark:via-purple-800 dark:to-gray-800 rounded-xl p-1 shadow-lg">
        <div className="bg-white dark:bg-gray-800 rounded-lg p-8">
          <div className="mb-6 flex justify-between items-center">
            <div>
              <h2 className="text-2xl font-bold mb-2">Your AI Generated Video</h2>
          ...
          {videos.length === 0 && (
            <div className="p-8 bg-gray-50 dark:bg-gray-700 rounded-lg text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Your video is still being generated. This may take up to 40 minutes. Please wait and refresh the page.
              </p>
          ...
          <p className="text-sm text-center text-amber-600 dark:text-amber-400 mt-6">
            Note: WAN AI video generation typically takes around 40 minutes to complete. If no video appears, please refresh after some time.
          </p>
